...
impl Hsla {
    ...
    /// Example:
    /// ```
    /// let color = voidui_gpui_wgpu::red();
...
pub struct Background {
    ...
    /// Index into the scene's variable-length gradient data (CssGradient only).
    pub(crate) gradient_index: u32,
}
...
impl std::fmt::Debug for Background {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self.tag {
            ...
            BackgroundTag::CssGradient => write!(f, "CssGradient({})", self.gradient_index),
...
impl Background {
    pub(crate) fn css_gradient(index: u32) -> Self {
        Self {
            tag: BackgroundTag::CssGradient,
...
impl Background {
    ...
    pub fn is_transparent(&self) -> bool {
        match self.tag {
            ...
            BackgroundTag::CssGradient => false,
        }
    }
}
