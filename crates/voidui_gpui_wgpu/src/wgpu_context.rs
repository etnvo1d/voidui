...
impl WgpuContext {
    ...
    fn new_with_options(
        ...
        let (adapter, device, queue, dual_source_blending, color_texture_format) =
            crate::block_on(Self::select_adapter_and_device(
                &instance,
                device_id_filter,
                surface,
    ...
    async fn select_adapter_and_device(
        ...
        // 3. Device type (Integrated > Discrete > Other > Virtual > Cpu).
        ...
        adapters.sort_by_key(|adapter| {
            ...
            let type_priority: u8 = if info.device_type == wgpu::DeviceType::Cpu {
                ...
                match info.device_type {
                    // UI workloads normally fit on the integrated GPU. Avoid
                    // waking a discrete GPU unless explicitly selected or needed
                    // for surface compatibility. Compositor matching still wins.
